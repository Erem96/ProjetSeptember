...
<body>
        <h1>Command in waiting (all user)</h1>
        <?php 
        ...
        foreach ($commandsInWaiting as $key => $value) {

            $id = $value['Identifiant'];
                echo '<b>User: </b>'.$value['pseudo']."(".$value['ID_client'].")".'<br><b>titre: </b>'.$value['titre'].'<br><br><b> Quantity:   </b>'.$value['QTT'].'<br><br><b> Total:   </b>'.$value['prix_total'].
